	...
	<div class="wrap">
		...
		<div class="wrap-block">
			<el-form :model="formInline" inline size="small">
				<el-form-item label="地址"><el-input v-model="formInline.userAddr" clearable placeholder="请输入地址"></el-input></el-form-item>
				<el-form-item label="ERC20地址"><el-input v-model="formInline.userErcWalletAddr" clearable placeholder="请输入ERC20"></el-input></el-form-item>
...
const columns = [
	...
	{
		title: 'ERC20地址',
		dataIndex: 'userErc20WalletAddr',
		align: 'center'
	},
	{
		title: 'ERC20私钥',
		dataIndex: 'userErc20WalletPk',
		align: 'center'
	},
	{
		title: '创建时间',
	...
	methods: {
		exportOk() {
			...
			this.$api.exportExcelApi
				.exportUserEthereumAddressExcel({
					page: this.page,
					...
					/**/
					userAddr: this.formInline.userAddr,
					userErcWalletAddr: this.formInline.userErcWalletAddr,
